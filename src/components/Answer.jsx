  ...
  return (
    <div className='flex flex-col gap-4'>
        {!isLoading && allOptions?.map((option) => (
            // <button className={`bg-orange-300 shadow-[4px_4px_0px_#fb923c] shadow-orange-400 hover:shadow-xl transform hover:translate-x-[2px] hover:translate-y-[2px] transition duration-300 ease-in-out text-[#242424] text-xl rounded-md py-2 ${selectedOption == option ? 'shadow-none border-2 border-orange-400':''}`} 
            //     key={option} 
